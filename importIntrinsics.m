function K1 = importIntrinsics(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [FX,VARNAME2] = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   [FX,VARNAME2] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [fx,VarName2] = importfile('0624 shot_Intr.txt',1, 7);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/09/13 12:24:50
